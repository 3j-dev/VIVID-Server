...
public class TeamsVideoApi {
    ...
    @PostMapping("/api/teams/video")
    @Operation(summary = "temas video 업로드 메소드", description = "teams video를 s3에 업로드하는 메소드 입니다..")
    @ApiResponse(responseCode = "200", description = "teams video 업로드 완료 후, 상태 코드 200을 반환합니다.")
